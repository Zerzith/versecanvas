            ...
            <div className="bg-[#1a1a1a] rounded-2xl overflow-hidden border-2 border-[#2a2a2a] sticky top-8">
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-3 gap-4 mb-6 pb-6 border-b border-[#2a2a2a]">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-pink-400">{story.views}</div>
                    <div className="text-xs text-gray-400">อ่าน</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-red-400">{story.likes}</div>
              ...
              <div className="space-y-2">
                {chapters.map((chapter) => (
                  <button
                    ...
                    className="w-full flex items-center justify-between p-4 rounded-xl bg-[#2a2a2a] hover:bg-[#3a3a3a] hover:border-purple-500 border-2 border-transparent transition group"
                  >
